...
export const LOCATIONS: Location[] = [
  ...
  // ----- Tenerife (localidades / barrios / zonas turísticas) -----
  { id: "tejina", name: "Tejina (La Laguna)", island: "Tenerife", lat: 28.5333, lon: -16.3717, type: "municipality", coastal: true },
  { id: "valle-guerra", name: "Valle de Guerra (La Laguna)", island: "Tenerife", lat: 28.5189, lon: -16.3858, type: "municipality", coastal: true },
  { id: "bajamar", name: "Bajamar (La Laguna)", island: "Tenerife", lat: 28.5481, lon: -16.3614, type: "municipality", coastal: true },
  { id: "punta-hidalgo", name: "Punta del Hidalgo (La Laguna)", island: "Tenerife", lat: 28.5722, lon: -16.3236, type: "municipality", coastal: true },
  { id: "taganana", name: "Taganana (Anaga)", island: "Tenerife", lat: 28.5697, lon: -16.2050, type: "municipality", coastal: true },
  { id: "almaciga", name: "Almáciga / Benijo", island: "Tenerife", lat: 28.5806, lon: -16.1869, type: "municipality", coastal: true },
  { id: "igueste", name: "Igueste de San Andrés", island: "Tenerife", lat: 28.5197, lon: -16.1681, type: "municipality", coastal: true },
  { id: "san-andres-tfe", name: "San Andrés (Las Teresitas)", island: "Tenerife", lat: 28.5081, lon: -16.1856, type: "municipality", coastal: true },
  { id: "la-esperanza", name: "La Esperanza (El Rosario)", island: "Tenerife", lat: 28.4486, lon: -16.3717, type: "municipality" },
  { id: "mesa-mar", name: "Mesa del Mar (Tacoronte)", island: "Tenerife", lat: 28.4942, lon: -16.4250, type: "municipality", coastal: true },
  { id: "el-pris", name: "El Pris (Tacoronte)", island: "Tenerife", lat: 28.4986, lon: -16.4108, type: "municipality", coastal: true },
  { id: "las-caletillas", name: "Las Caletillas (Candelaria)", island: "Tenerife", lat: 28.3697, lon: -16.3711, type: "municipality", coastal: true },
  { id: "las-americas", name: "Playa de las Américas (Arona)", island: "Tenerife", lat: 28.0586, lon: -16.7283, type: "municipality", coastal: true },
  { id: "las-galletas", name: "Las Galletas (Arona)", island: "Tenerife", lat: 28.0144, lon: -16.6611, type: "municipality", coastal: true },
  { id: "costa-silencio", name: "Costa del Silencio (Arona)", island: "Tenerife", lat: 28.0036, lon: -16.6500, type: "municipality", coastal: true },
  { id: "la-caleta", name: "La Caleta (Adeje)", island: "Tenerife", lat: 28.1186, lon: -16.7625, type: "municipality", coastal: true },
  { id: "playa-paraiso", name: "Playa Paraíso (Adeje)", island: "Tenerife", lat: 28.1058, lon: -16.7800, type: "municipality", coastal: true },
  { id: "callao-salvaje", name: "Callao Salvaje (Adeje)", island: "Tenerife", lat: 28.1233, lon: -16.7825, type: "municipality", coastal: true },
  { id: "playa-san-juan", name: "Playa de San Juan (Guía de Isora)", island: "Tenerife", lat: 28.1822, lon: -16.8181, type: "municipality", coastal: true },
  { id: "alcala", name: "Alcalá (Guía de Isora)", island: "Tenerife", lat: 28.2042, lon: -16.8278, type: "municipality", coastal: true },
  { id: "puertito-guimar", name: "Puertito de Güímar", island: "Tenerife", lat: 28.3019, lon: -16.3781, type: "municipality", coastal: true },
  { id: "poris-abona", name: "Poris de Abona (Arico)", island: "Tenerife", lat: 28.1639, lon: -16.4361, type: "municipality", coastal: true },
  { id: "los-abrigos", name: "Los Abrigos (Granadilla)", island: "Tenerife", lat: 28.0247, lon: -16.5719, type: "municipality", coastal: true },
  { id: "los-cristianos", name: "Los Cristianos (Arona)", island: "Tenerife", lat: 28.0506, lon: -16.7150, type: "municipality", coastal: true },
